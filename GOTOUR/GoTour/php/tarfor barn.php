...
<body>
  ...
  <section class="package-detail">
    <h1>Tafsor Barn</h1>
    <img src="../images/tafsor barn.jpg" alt="Tafsor Barn">
    ...
    <button><a href="../php/pembayaran khai.php">Pesan Sekarang</a></button>
    <button><a href="../php/halaman diskon.php">Lihat Halaman Diskon</a></button>
