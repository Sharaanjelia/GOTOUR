...
<body>
  <nav class="navbar">
    <div class="logo">
      <a href="../php/../php/tentangkami.php"> 
        <img src="../images/IMG_7079-removebg-preview.png" alt="GoTour Logo" style="height: 30px;">
      </a>  
    </div>
    <ul class="nav-links">
  ...
  <section class="package-detail">
    <h1>Tebing Karaton</h1>
    <img src="../images/Tebing karaton.webp" alt="Tebing Karaton">
    <p>Durasi: 2 Hari 1 Malam</p>
    <p>Harga: Mulai dari Rp800.000</p>
    <h2>Deskripsi</h2>
    <p>Tebing Keraton adalah sebuah tebing dengan pemandangan luar biasa di area Taman Hutan Raya Ir. H. Djuanda. Kalau ingin merasakan pengalaman melihat lautan pohon yang hijau dari atas tebing, di sinilah tempatnya. Banyak orang juga yang datang sekitar subuh untuk melihat matahari terbit di sini, jadi pastikan kamu juga mencoba pengalaman tersebut saat liburan ke Bandung.</p>
    ...
    <button><a href="../php/pembayaran_khai.php">Pesan Sekarang</a></button>
    <button><a href="../php/halaman_diskon.php">Lihat Halaman Diskon</a></button>
    <button><a href="../php/rekomendasifoto.php">Rekomendasi Gaya Foto</a></button>
  </section>
